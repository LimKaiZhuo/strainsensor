...
#selector(case=1, loader_excel='./excel/Data_loader_spline_full_onehot_R1_cut_CM3.xlsx')
#selector(case=1, loader_excel='./excel/Data_loader_spline_full_onehot_R2_cut_CM3.xlsx')
#selector(case=1, loader_excel='./excel/Data_loader_spline_full_onehot_R3_cut_CM3.xlsx')
#selector(case=1, round=4, loader_excel='./excel/Data_loader_spline_full_onehot_R4_cut_CM3.xlsx', save_model=False)
#selector(case=1, round=5, loader_excel='./excel/Data_loader_spline_full_onehot_R5_cut_CM3.xlsx', save_model=False)
#selector(case=1, round=6, loader_excel='./excel/Data_loader_spline_full_onehot_R6_cut_CM3.xlsx', save_model=False)
#selector(case=1, round='6e', loader_excel='./excel/Data_loader_spline_full_onehot_R6e_cut_CM3.xlsx', save_model=False)
#selector(case=1, round=7, loader_excel='./excel/Data_loader_spline_full_onehot_R7_cut_CM3.xlsx', save_model=False)
selector(case=1, round=9, loader_excel='./excel/Data_loader_spline_full_onehot_R9_cut_CM3.xlsx', save_model=False)
