...
hparams = create_hparams(shared_layers=[20,20], ts_layers=[5,5], cs_layers=[5,5], epochs=5000,reg_l1=0.05, reg_l2=0.,
...
run_skf('ann2', 'ann', 'skf', hparams, norm_mask=None, labels_norm=False,
...
"""
plot_predicted_splines('./results/skf2', fn=5)
plot_predicted_splines('./results/skf3', fn=5)
plot_predicted_splines('./results/skf4', fn=5)
plot_predicted_splines('./results/skf5', fn=5)
